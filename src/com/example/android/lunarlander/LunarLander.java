...
public class LunarLander extends Activity {
    ...
    private static final int MENU_TRIVIAL = 8;
    
    private static final int MENU_AUTO = 9;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add(0, MENU_TRIVIAL, 0, R.string.menu_trivial);
        menu.add(0, MENU_MEDIUM, 0, R.string.menu_medium);
        menu.add(0, MENU_HARD, 0, R.string.menu_hard);
        menu.add(0, MENU_AUTO, 0, R.string.menu_auto);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case MENU_EASY:
                ...
                return true;
            case MENU_TRIVIAL:
                mLunarThread.setDifficulty(LunarThread.DIFFICULTY_TRIVIAL);
                return true;
            case MENU_MEDIUM:
